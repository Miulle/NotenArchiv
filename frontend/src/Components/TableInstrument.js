...
export default function DenseTable() {
    ...
    async function sampleFunc() {
        let response = await fetch("/api/instrument");
                    ...
                    <Table className={classes.table} stickyHeader size="small" aria-label="a dense table">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="center">Abkuerzung</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {(rowsPerPage > 0
                                ...
                                <TableRow hover key={row.instrumentID} onClick={() => handleClick(row.instrumentID)}>
                                    {/*TODO: implement proper onClick function*/}
                                    <TableCell component="th" scope="row" align="center" >
                                        {row.instrument}
                                    </TableCell>
                                    <TableCell align="center" >{row.abkuerzung}</TableCell>
                                </TableRow>
                            ))}
                            {emptyRows > 0 && (
